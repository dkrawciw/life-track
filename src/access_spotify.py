...
def get_podcast(show_id: str, episode_limit: int = 1):
    podcast = get_podcast_info(show_id=show_id)
    episodes = get_podcast_episodes(show_id=show_id, limit=episode_limit)
